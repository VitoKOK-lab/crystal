...
// every bead (most noticeable where a small bead sits beside a large one), so
// stones/spacers render slightly larger than their tangent-implied diameter
// to close that gap. Charms are unaffected — they hang outward from the loop.
const BEAD_OVERLAP = 1.16;
