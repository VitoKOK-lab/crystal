...
export default function Checkout({ lines, baseFee, dominant, totalEnergy, initialWrist, onBack }: {
  ...
  const orderText = () => [
    ...
    `主屬性：${dominant.zh} ${dominant.en}（總戰力 ${totalEnergy.toLocaleString()}）`,
  ...
  if (step === "done") return <section className="checkout done-view">
    <div className="done-card">
      ...
      <div className="done-energy">此手鍊的主屬性 <b style={{ color: dominant.color }}>{dominant.zh} {dominant.en}</b>・總戰力 <em>{totalEnergy.toLocaleString()}</em></div>
  ...
  return <section className="checkout">
    ...
    <div className="co-grid">
      <aside className="co-summary">
        ...
        <h2>你的專屬手鍊</h2>
        <div className="co-energy-chip">主屬性 <b style={{ color: dominant.color }}>{dominant.zh} {dominant.en}</b><em>TOTAL POWER {totalEnergy.toLocaleString()}</em></div>
