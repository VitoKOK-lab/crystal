...
export async function generateShareCard(opts: {
  ...
  ctx.fillText("C R Y S T A L   M E N", W / 2, 148);
  ctx.fillStyle = "#6b6b6b";
  ctx.font = "500 17px Arial, sans-serif";
  ctx.fillText("F O R G E   Y O U R   O W N   P O W E R", W / 2, 186);
  ...
  ctx.fillText("D O M I N A N T   P O W E R", cx, cy - 46);
  ctx.save();
  ...
  ctx.fillText("TOTAL POWER", tx, 1000);
  ctx.save();
